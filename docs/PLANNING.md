...
- **D\* Lite**: Dynamic replanning stub exists (`DStarLite` in `planning.discrete.api`, raises `NotImplementedError`). Full implementation is not planned — see [ROADMAP.md](ROADMAP.md).
